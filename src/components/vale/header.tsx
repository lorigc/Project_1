  ...
  return (
    <header className="flex w-full flex-wrap items-center justify-between gap-x-5 gap-y-3">
      <div className="flex flex-wrap items-center gap-x-[24px] gap-y-2">
        <p className="text-[18px] font-extrabold leading-[22px] text-[#fafafa]">
          Vale<span className="text-[#3e9300]">.</span>
        </p>
          ...
          {valePlatforms.map(p => {
            ...
            return (
              <button
                ...
                aria-pressed={on}
                className={cn(
                  "flex items-center gap-[8px] rounded-full border border-[#222226] px-[12px] py-[5px] transition-colors focus-visible:outline-2 focus-visible:outline-[#3e9300]",
      ...
      <div className="flex items-center gap-[20px]">
        ...
        <button
          ...
          className="relative flex size-[36px] items-center justify-center rounded-full border border-[#222226] bg-[#121214] transition-colors hover:bg-[#222226]/60 focus-visible:outline-2 focus-visible:outline-[#3e9300]"
        >
          <Bell className="size-[18px] text-[#a1a1aa]" aria-hidden />
          <span className="absolute right-[7px] top-[7px] size-[6px] rounded-full bg-[#3e9300]" aria-hidden />
        </button>
